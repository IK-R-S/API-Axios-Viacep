...
function Home({ navigation }){
    ...
    let link = `https://www.google.com.br/maps/search/${result?.cep},%20${result?.uf}`
                ...
                result.uf ? (
                    <>
                        ...
                        <View style={styles.bottomButtonsView}>
                            ...
                            <TouchableOpacity style={styles.qrButton} onPress={() => navigation.navigate('Qrcode', {qrlink: link})}>
